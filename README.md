...
Apache Cordova를 기반으로 개발하여, HTML5/CSS3/Javascript(ECMAscript5)를 개발도구로 사용합니다.<br>
...
https://m.blog.naver.com/imagine0716/220921097859<br>
스마트폰 모델에 따라서, 이동통신 혹은 WiFi에 접속이 되지 않으면, 위치 정보를 수집하지 못할수 있습니다.<br><br>
### IOS 스마트폰에 설치 및 실행 하기
